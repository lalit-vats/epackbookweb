import { Box, Drawer, Grid, IconButton, Link, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Stack, Tooltip, useMediaQuery } from "@mui/material";
                                    ...
                                    <Box className="rightSide">
                                        {
                                            navItems.map((d, i) => (
                                                <Box>
                                                    <Link key={i} href={d.path}>{d.label}</Link>
                                                </Box>
                                            ))
                                        }
                                    </Box>
